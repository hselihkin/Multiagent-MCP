using TimeseriesMCPServer;
using TimeseriesMCPServer.ProjectResources;
using TimeseriesMCPServer.Prompts;
using TimeseriesMCPServer.Tools;
...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        kernelBuilder.Plugins.AddFromType<TimeseriesUtils>();
        ...
        builder.Services
            ...
            .WithTools()
            .WithPrompt(PromptDefinition.Create(EmbeddedResource.ReadAsString("getTimeseriesForStream.json")));
